...
file_name = (r"C:\Users\alexh\Documents\Geology\Python_Geology\csv files\Hydrology_Fall_City.csv")
    ...
    def weather_file(file_nametuple):
        ...
        with open(file_name,'r') as file:
            ...
            for line in file:
                ...
                record[dictlist[1]] = str(line[1])
                
                record[dictlist[2]] = float(line[2])
                
                record[dictlist[3]] = str(line[3])
